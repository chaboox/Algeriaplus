...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C02051 implements OnAttachStateChangeListener {
        C02051() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C02051());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C02062());
    }
