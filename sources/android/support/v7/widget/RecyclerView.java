...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04931();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04942();
        private int mWidth;
        ...
        class C04931 implements Callback {
            C04931() {
            }
        ...
        class C04942 implements Callback {
            C04942() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0182R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0182R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0182R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0182R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0182R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C04904 implements ProcessCallback {
        C04904() {
        }
    ...
    class C04915 implements Callback {
        C04915() {
        }
    ...
    class C04926 implements Callback {
        C04926() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04951());
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C04951 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04951() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02121();
        ...
        this.mItemAnimatorRunner = new C02132();
        this.mViewInfoProcessCallback = new C04904();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0182R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0182R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0182R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04915());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04926());
    }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (canRunFocusFailure && (direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                absDir = direction == 2 ? TransportMediator.KEYCODE_MEDIA_RECORD : 33;
