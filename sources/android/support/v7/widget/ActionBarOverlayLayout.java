...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0180R.attr.actionBarSize, 16842841};
    ...
    class C06241 extends ViewPropertyAnimatorListenerAdapter {
        C06241() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C06241();
        this.mRemoveActionBarHideOffset = new C01922();
        this.mAddActionBarHideOffset = new C01933();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0180R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0180R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0180R.id.action_bar));
        }
    }
