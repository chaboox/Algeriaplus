...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C01831();
        ...
        public void dispatchUpdatesTo(ListUpdateCallback updateCallback) {
            ...
            for (int snakeIndex = this.mSnakes.size() - 1; snakeIndex >= 0; snakeIndex--) {
                ...
                for (int i = snakeSize - 1; i >= 0; i--) {
                    if ((this.mOldItemStatuses[snake.f9x + i] & 31) == 2) {
                        batchingCallback.onChanged(snake.f9x + i, 1, this.mCallback.getChangePayload(snake.f9x + i, snake.f10y + i));
                    }
                }
                posOld = snake.f9x;
                posNew = snake.f10y;
