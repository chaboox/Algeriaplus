...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C06211();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C06222();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04713();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C04713 implements ViewPropertyAnimatorUpdateListener {
        C04713() {
        }
    ...
    class C06211 extends ViewPropertyAnimatorListenerAdapter {
        C06211() {
        }
    ...
    class C06222 extends ViewPropertyAnimatorListenerAdapter {
        C06222() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0180R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0180R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0180R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0180R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0180R.styleable.ActionBar, C0180R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0180R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0180R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0180R.attr.actionBarWidgetTheme, outValue, true);
