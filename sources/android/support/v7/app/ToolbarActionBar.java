...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C04702();
    private final Runnable mMenuInvalidator = new C01791();
    ...
    class C04702 implements OnMenuItemClickListener {
        C04702() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0180R.layout.abc_list_menu_item_layout);
