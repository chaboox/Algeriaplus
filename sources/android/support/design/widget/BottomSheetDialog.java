...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C04032 extends AccessibilityDelegateCompat {
        C04032() {
        }
    ...
    class C04043 extends BottomSheetCallback {
        C04043() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C04043();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        coordinator.findViewById(C0010R.id.touch_outside).setOnClickListener(new C00191());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C04032());
        return coordinator;
    }
