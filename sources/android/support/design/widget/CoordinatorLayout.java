...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0010R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0010R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0010R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0010R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0010R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0010R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0010R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0010R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0010R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
    ...
    class C04081 implements OnApplyWindowInsetsListener {
        C04081() {
        }
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04091());
        SparseArray<Parcelable> behaviorStates;

        /* renamed from: android.support.design.widget.CoordinatorLayout$SavedState$1 */
        static class C04091 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04091() {
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0010R.styleable.CoordinatorLayout, defStyleAttr, C0010R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0010R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0010R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C04081();
                }
