...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C04061 implements OnApplyWindowInsetsListener {
        C04061() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0010R.styleable.CollapsingToolbarLayout, defStyleAttr, C0010R.style.Widget_Design_CollapsingToolbar);
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0180R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04061());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C04072());
