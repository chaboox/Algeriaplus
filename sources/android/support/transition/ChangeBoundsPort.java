...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00373 extends AnimatorListenerAdapter {
        C00373() {
        }
    ...
    class C06121 extends TransitionListenerAdapter {
    ...
    class C06132 extends TransitionListenerAdapter {
        boolean mCanceled = false;
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C06132());
                    }
                    anim.addListener(new C00373());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
                ...
                if (startLeft != endLeft) {
                    pvhIndex = 0 + 1;
                    pvh[0] = PropertyValuesHolder.ofInt("left", new int[]{startLeft, endLeft});
                } else {
                    pvhIndex = 0;
                }
                if (startTop != endTop) {
                ...
                if (startRight != endRight) {
                    i = pvhIndex + 1;
                    pvh[pvhIndex] = PropertyValuesHolder.ofInt("right", new int[]{startRight, endRight});
                    pvhIndex = i;
                }
                if (startBottom != endBottom) {
                    i = pvhIndex + 1;
