...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00692();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00681();
    ...
    class C00692 implements OnItemClickListener {
        C00692() {
        }
