...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        /* renamed from: b */
        private android.app.Notification.Builder f22b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f22b, action));
        }
        ...
        public Notification build() {
            ...
            this.f22b.setExtras(this.mExtras);
            Notification notification = this.f22b.build();
