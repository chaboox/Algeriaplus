...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C00501 implements Creator<SavedState> {
            C00501() {
            }
    ...
    class C04252 extends FragmentContainer {
        C04252() {
        }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C04252(), this);
    }
