...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00711();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C04302();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00711 implements ThreadFactory {
    ...
    class C04302 extends WorkerRunnable<Params, Result> {
        C04302() {
        }
