...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01191();
    ...
    static class C01191 implements Creator<PlaybackStateCompat> {
        C01191() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01201();
        ...
        static class C01201 implements Creator<CustomAction> {
            C01201() {
            }
