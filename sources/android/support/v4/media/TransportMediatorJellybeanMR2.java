...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C01074();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C01085();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C01063();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C01096();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C01041();
    final OnWindowFocusChangeListener mWindowFocusListener = new C01052();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C01041 implements OnWindowAttachListener {
        C01041() {
        }
    ...
    class C01052 implements OnWindowFocusChangeListener {
        C01052() {
        }
    ...
    class C01063 extends BroadcastReceiver {
        C01063() {
        }
    ...
    class C01074 implements OnAudioFocusChangeListener {
        C01074() {
        }
    ...
    class C01085 implements OnGetPlaybackPositionListener {
        C01085() {
        }
    ...
    class C01096 implements OnPlaybackPositionUpdateListener {
        C01096() {
        }
