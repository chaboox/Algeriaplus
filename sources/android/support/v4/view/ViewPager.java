...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01371();
    ...
    private static final Interpolator sInterpolator = new C01382();
    ...
    private final Runnable mEndScrollRunnable = new C01393();
    ...
    static class C01371 implements Comparator<ItemInfo> {
        C01371() {
        }
    ...
    static class C01382 implements Interpolator {
        C01382() {
        }
    ...
    class C04534 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04541());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C04541 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04541() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04534());
    }
