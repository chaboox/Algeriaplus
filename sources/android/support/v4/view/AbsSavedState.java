...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C04482());
    public static final AbsSavedState EMPTY_STATE = new C04471();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C04471 extends AbsSavedState {
        C04471() {
            super();
        }
    }
    ...
    static class C04482 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C04482() {
        }
