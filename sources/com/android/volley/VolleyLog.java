...
public class VolleyLog {
    ...
    static class MarkerLog {
        ...
        public synchronized void finish(String header) {
            ...
            if (getTotalDuration() > 0) {
                ...
                VolleyLog.m9d("(%-4d ms) %s", Long.valueOf(duration), header);
                for (Marker marker : this.mMarkers) {
                    VolleyLog.m9d("(+%-4d) [%2d] %s", Long.valueOf(marker.time - prevTime), Long.valueOf(marker.thread), marker.name);
        ...
        protected void finalize() throws Throwable {
            if (!this.mFinished) {
                ...
                VolleyLog.m10e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
    ...
    public static void setTag(String tag) {
        m9d("Changing log tag to %s", tag);
        TAG = tag;
        DEBUG = Log.isLoggable(TAG, 2);
    }

    /* renamed from: v */
    public static void m12v(String format, Object... args) {
        if (DEBUG) {
    ...
    /* renamed from: d */
    public static void m9d(String format, Object... args) {
        Log.d(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m10e(String format, Object... args) {
        Log.e(TAG, buildMessage(format, args));
    }

    /* renamed from: e */
    public static void m11e(Throwable tr, String format, Object... args) {
