...
public final class Gson {
    ...
    class C03591 extends ThreadLocal<Map<TypeToken<?>, FutureTypeAdapter<?>>> {
        C03591() {
        }
    ...
    class C05602 implements JsonDeserializationContext {
        C05602() {
        }
    ...
    class C05613 implements JsonSerializationContext {
        C05613() {
        }
    ...
    class C05624 extends TypeAdapter<Number> {
        C05624() {
        }
    ...
    class C05635 extends TypeAdapter<Number> {
        C05635() {
        }
    ...
    class C05646 extends TypeAdapter<Number> {
        C05646() {
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingPolicy, Map<Type, InstanceCreator<?>> instanceCreators, boolean serializeNulls, boolean complexMapKeySerialization, boolean generateNonExecutableGson, boolean htmlSafe, boolean prettyPrinting, boolean serializeSpecialFloatingPointValues, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> typeAdapterFactories) {
        this.calls = new C03591();
        this.typeTokenCache = Collections.synchronizedMap(new HashMap());
        this.deserializationContext = new C05602();
        this.serializationContext = new C05613();
