...
import com.chaboox.algeriaplus.BuildConfig;
...
public class AppMeasurement {
    ...
    public static class zzf {
        ...
        public zzf(zzf zzf) {
            this.zzbpz = zzf.zzbpz;
            this.zzbpA = zzf.zzbpA;
            this.zzbpB = zzf.zzbpB;
        }
    }
    ...
    public AppMeasurement(zzatp zzatp) {
        zzac.zzw(zzatp);
        this.zzbpw = zzatp;
    }
    ...
    public void registerOnScreenChangeCallback(@NonNull zzd zzd) {
        this.zzbpw.zzJm().registerOnScreenChangeCallback(zzd);
    }
    ...
    public void unregisterOnScreenChangeCallback(@NonNull zzd zzd) {
        this.zzbpw.zzJm().unregisterOnScreenChangeCallback(zzd);
    }

    @WorkerThread
    public void zza(zzb zzb) {
        this.zzbpw.zzJi().zza(zzb);
    }

    public void zza(zzc zzc) {
        this.zzbpw.zzJi().zza(zzc);
    }
    ...
    public Map<String, Object> zzaE(boolean z) {
        ...
        for (zzaub zzaub : zzaI) {
            hashMap.put(zzaub.name, zzaub.getValue());
        }
        return hashMap;
    }
