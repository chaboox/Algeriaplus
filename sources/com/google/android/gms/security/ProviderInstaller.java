...
public class ProviderInstaller {
    ...
    class C03401 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener zzbCc;
        final /* synthetic */ Context zztd;

        C03401(Context context, ProviderInstallListener providerInstallListener) {
            this.zztd = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C03401(context, providerInstallListener).execute(new Void[0]);
    }
