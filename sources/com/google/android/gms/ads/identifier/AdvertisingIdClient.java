...
public class AdvertisingIdClient {
    ...
    static zzcn zza(Context context, com.google.android.gms.common.zza zza) throws IOException {
        try {
            return com.google.android.gms.internal.zzcn.zza.zzf(zza.zza(10000, TimeUnit.MILLISECONDS));
        } catch (InterruptedException e) {
        ...
        try {
            ...
            switch (zzc.zzuz().isGooglePlayServicesAvailable(context)) {
                ...
                case 2:
                    ...
                    try {
                        if (com.google.android.gms.common.stats.zza.zzyc().zza(context, intent, zza, 1)) {
                            return zza;
                        }
    ...
    L_0x000f:
        return;
    L_0x0010:
        r0 = r3.zzsg;	 Catch:{ IllegalArgumentException -> 0x002d, Throwable -> 0x0036 }
        if (r0 == 0) goto L_0x001f;
    L_0x0014:
        r0 = com.google.android.gms.common.stats.zza.zzyc();	 Catch:{ IllegalArgumentException -> 0x002d, Throwable -> 0x0036 }
        r1 = r3.mContext;	 Catch:{ IllegalArgumentException -> 0x002d, Throwable -> 0x0036 }
        r2 = r3.zzse;	 Catch:{ IllegalArgumentException -> 0x002d, Throwable -> 0x0036 }
