...
import com.google.android.gms.C0272R;
...
public final class zzaas {
    ...
    zzaas(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C0272R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
