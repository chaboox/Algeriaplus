...
public class FloatingActionButton extends ImageButton {
    ...
    private static final Xfermode PORTER_DUFF_CLEAR = new PorterDuffXfermode(Mode.CLEAR);
    ...
    class C02551 extends ViewOutlineProvider {
        C02551() {
        }
    ...
    class C02562 extends SimpleOnGestureListener {
        C02562() {
        }

        public boolean onDown(MotionEvent e) {
            Label label = (Label) FloatingActionButton.this.getTag(C0271R.id.fab_label);
            if (label != null) {
                label.onActionDown();
            }
    ...
    class C02584 implements AnimationListener {
        C02584() {
        }
    ...
    static class ProgressSavedState extends BaseSavedState {
        public static final Creator<ProgressSavedState> CREATOR = new C02591();
        ...
        static class C02591 implements Creator<ProgressSavedState> {
            C02591() {
            }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mGestureDetector = new GestureDetector(getContext(), new C02562());
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray attr = context.obtainStyledAttributes(attrs, C0271R.styleable.FloatingActionButton, defStyleAttr, 0);
        this.mColorNormal = attr.getColor(C0271R.styleable.FloatingActionButton_fab_colorNormal, -2473162);
        this.mColorPressed = attr.getColor(C0271R.styleable.FloatingActionButton_fab_colorPressed, -1617853);
        this.mColorDisabled = attr.getColor(C0271R.styleable.FloatingActionButton_fab_colorDisabled, -5592406);
        this.mColorRipple = attr.getColor(C0271R.styleable.FloatingActionButton_fab_colorRipple, -1711276033);
        this.mShowShadow = attr.getBoolean(C0271R.styleable.FloatingActionButton_fab_showShadow, true);
        this.mShadowColor = attr.getColor(C0271R.styleable.FloatingActionButton_fab_shadowColor, 1711276032);
        this.mShadowRadius = attr.getDimensionPixelSize(C0271R.styleable.FloatingActionButton_fab_shadowRadius, this.mShadowRadius);
        this.mShadowXOffset = attr.getDimensionPixelSize(C0271R.styleable.FloatingActionButton_fab_shadowXOffset, this.mShadowXOffset);
        this.mShadowYOffset = attr.getDimensionPixelSize(C0271R.styleable.FloatingActionButton_fab_shadowYOffset, this.mShadowYOffset);
        this.mFabSize = attr.getInt(C0271R.styleable.FloatingActionButton_fab_size, 0);
        this.mLabelText = attr.getString(C0271R.styleable.FloatingActionButton_fab_label);
        this.mShouldProgressIndeterminate = attr.getBoolean(C0271R.styleable.FloatingActionButton_fab_progress_indeterminate, false);
        this.mProgressColor = attr.getColor(C0271R.styleable.FloatingActionButton_fab_progress_color, -16738680);
        this.mProgressBackgroundColor = attr.getColor(C0271R.styleable.FloatingActionButton_fab_progress_backgroundColor, 1291845632);
        this.mProgressMax = attr.getInt(C0271R.styleable.FloatingActionButton_fab_progress_max, this.mProgressMax);
        this.mShowProgressBackground = attr.getBoolean(C0271R.styleable.FloatingActionButton_fab_progress_showBackground, true);
        if (attr.hasValue(C0271R.styleable.FloatingActionButton_fab_progress)) {
            this.mProgress = attr.getInt(C0271R.styleable.FloatingActionButton_fab_progress, 0);
            this.mShouldSetProgress = true;
        }
        if (attr.hasValue(C0271R.styleable.FloatingActionButton_fab_elevationCompat)) {
            float elevation = (float) attr.getDimensionPixelOffset(C0271R.styleable.FloatingActionButton_fab_elevationCompat, 0);
            if (isInEditMode()) {
    ...
    private void initShowAnimation(TypedArray attr) {
        this.mShowAnimation = AnimationUtils.loadAnimation(getContext(), attr.getResourceId(C0271R.styleable.FloatingActionButton_fab_showAnimation, C0271R.anim.fab_scale_up));
    }

    private void initHideAnimation(TypedArray attr) {
        this.mHideAnimation = AnimationUtils.loadAnimation(getContext(), attr.getResourceId(C0271R.styleable.FloatingActionButton_fab_hideAnimation, C0271R.anim.fab_scale_down));
    }

    private int getCircleSize() {
        return getResources().getDimensionPixelSize(this.mFabSize == 0 ? C0271R.dimen.fab_size_normal : C0271R.dimen.fab_size_mini);
    }
    ...
    Label getLabelView() {
        return (Label) getTag(C0271R.id.fab_label);
    }
    ...
    void onActionUp() {
        if (this.mBackgroundDrawable instanceof StateListDrawable) {
            this.mBackgroundDrawable.setState(new int[]{16842910});
        } else if (Util.hasLollipop()) {
            RippleDrawable ripple = this.mBackgroundDrawable;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (this.mClickListener != null && isEnabled()) {
            Label label = (Label) getTag(C0271R.id.fab_label);
            if (label == null) {
    ...
    public void setOnClickListener(OnClickListener l) {
        ...
        View label = (View) getTag(C0271R.id.fab_label);
        if (label != null) {
            label.setOnClickListener(new C02573());
        }
    }
    ...
    public void hideButtonInMenu(boolean animate) {
        if (!isHidden() && getVisibility() != 8) {
            ...
            getHideAnimation().setAnimationListener(new C02584());
        }
    }
