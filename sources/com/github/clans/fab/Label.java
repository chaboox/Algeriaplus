...
public class Label extends TextView {
    ...
    GestureDetector mGestureDetector = new GestureDetector(getContext(), new C02702());
    ...
    class C02691 extends ViewOutlineProvider {
        C02691() {
        }
    ...
    class C02702 extends SimpleOnGestureListener {
        C02702() {
        }
