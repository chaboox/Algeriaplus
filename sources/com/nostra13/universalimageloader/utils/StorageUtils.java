...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        C0382L.m18w("Can't define system cache directory! '%s' will be used.", "/data/data/" + context.getPackageName() + "/cache/");
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (appCacheDir.mkdirs()) {
            try {
                ...
                C0382L.m17i("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
                return appCacheDir;
            }
        }
        C0382L.m18w("Unable to create external cache directory", new Object[0]);
        return null;
    }
